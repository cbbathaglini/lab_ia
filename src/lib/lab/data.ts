...
export const SEED_DOCS: LabDoc[] = [
  {
    ...
    metadata: { departamento: "RH", ano: 2026, tipo: "politica", pagina: 17 },
  },
  {
    id: "doc_home_office",
    ...
    metadata: { departamento: "RH", ano: 2025, tipo: "politica", pagina: 3 },
  },
  {
    id: "doc_beneficios",
    name: "beneficios.pdf",
    ...
    metadata: { departamento: "RH", ano: 2026, tipo: "manual", pagina: 8 },
  },
  {
    id: "doc_seguranca",
    name: "seguranca.md",
    ...
    metadata: { departamento: "TI", ano: 2026, tipo: "procedimento", pagina: 42 },
  },
  {
    id: "doc_viagens",
    name: "viagens.csv",
    ...
    metadata: { departamento: "Financeiro", ano: 2025, tipo: "procedimento", pagina: 12 },
  },
];
...
export const FORMATS = ["PDF", "DOCX", "TXT", "HTML", "Markdown", "CSV", "Banco de dados"];
...
export const EMBEDDING_POINTS = [
  { text: "férias", group: "Férias", x: 0.18, y: 0.78 },
  { text: "descanso anual", group: "Férias", x: 0.26, y: 0.85 },
  { text: "período de férias", group: "Férias", x: 0.12, y: 0.68 },
  { text: "30 dias de descanso", group: "Férias", x: 0.24, y: 0.66 },
  { text: "senha bloqueada", group: "Segurança", x: 0.8, y: 0.24 },
  { text: "erro de login", group: "Segurança", x: 0.88, y: 0.34 },
  { text: "tentativas de acesso", group: "Segurança", x: 0.74, y: 0.14 },
  { text: "vale alimentação", group: "Alimentação", x: 0.62, y: 0.82 },
  { text: "benefício alimentação", group: "Alimentação", x: 0.72, y: 0.9 },
  { text: "home office", group: "Trabalho remoto", x: 0.42, y: 0.36 },
  { text: "trabalho remoto", group: "Trabalho remoto", x: 0.5, y: 0.44 },
] as const;
...
export const GLOSSARY: GlossaryEntry[] = [
  {
    ...
    detail:
      "Modelos não leem letras nem palavras inteiras: leem tokens, pedaços de texto de ~4 caracteres em média. Tudo é cobrado e limitado em tokens.",
  ...
  },
  {
    ...
    detail:
      "Documentos inteiros não cabem (nem deveriam caber) no contexto. Quebramos em chunks para recuperar apenas as partes relevantes.",
  ...
  },
  {
    ...
    detail:
      "Replica uma parte do fim de um chunk no início do próximo para não perder contexto exatamente na fronteira do corte.",
  ...
  },
  {
    ...
    detail:
      "Um modelo de embedding transforma texto em um vetor de centenas ou milhares de números. Textos com sentido próximo geram vetores próximos.",
  ...
  },
  {
    ...
    detail:
      "O vetor é um ponto em um espaço de alta dimensão. A distância entre pontos aproxima a distância de significado.",
  ...
  },
  {
    ...
    detail:
      "Guarda vetores + texto + metadata e responde 'quais os N vetores mais parecidos com este?' em milissegundos, usando índices como HNSW.",
  ...
  },
  {
    ...
    detail:
      "Vai de -1 a 1. Perto de 1 significa mesma direção no espaço semântico, ou seja, significado parecido — independentemente do tamanho do texto.",
  ...
  },
  {
    ...
    detail:
      "Departamento, ano, tipo, autor, permissão. Permite filtrar antes da busca vetorial e reduzir drasticamente o universo pesquisado.",
  ...
  },
  {
    ...
    detail:
      "Recebe a pergunta, gera o embedding, aplica filtros e devolve os candidatos mais próximos do Vector DB.",
  ...
  },
  {
    ...
    detail:
      "K baixo = contexto enxuto e barato, risco de perder informação. K alto = mais recall, mais ruído e mais tokens.",
  ...
  },
  {
    ...
    detail:
      "Normalmente um cross-encoder que lê pergunta e chunk juntos. É mais caro, então roda só sobre os candidatos já filtrados.",
  ...
  },
  {
    ...
    detail:
      "Orçamento total de tokens da chamada: system prompt + contexto + pergunta + resposta. É finito e custa dinheiro.",
  ...
  },
  {
    ...
    detail:
      "Recebe apenas o que está no contexto. Ele não consulta seus documentos: ele lê o que o pipeline de retrieval entregou.",
  ...
  },
  {
    ...
    detail:
      "Arquitetura em que a resposta é gerada com base em trechos recuperados de uma base de conhecimento, e não apenas no que o modelo memorizou.",
  ...
  },
  {
    ...
    detail:
      "Em vez de responder uma pergunta, o agente planeja, escolhe ferramentas, executa, observa o resultado e decide o próximo passo.",
  ...
  },
  {
    ...
    detail:
      "Descrita por nome, descrição e schema de argumentos. O modelo escolhe a tool e os argumentos; o seu código executa de verdade.",
  ...
  },
  {
    ...
    detail:
      "Curto prazo: histórico da execução atual. Longo prazo: preferências e fatos persistidos, frequentemente em um Vector DB.",
  ...
  },
  {
    ...
    detail:
      "Roda até o objetivo ser atingido ou um limite de passos/custo ser alcançado. É o que diferencia um agente de uma única chamada.",
...
export const QUIZ: QuizQuestion[] = [
  {
    question:
      "Um documento tem 10.000 tokens e o chunk size é 500 (sem overlap). Aproximadamente quantos chunks serão criados?",
    options: ["5", "20", "200", "2.000"],
    answer: 1,
  ...
  },
  {
    ...
    options: ["LLM", "Vector Database", "Frontend", "API Gateway"],
    answer: 1,
    explanation:
      "O Vector Database faz a busca por similaridade. O LLM só recebe o resultado dessa busca.",
  },
  {
    ...
    answer: 1,
    explanation:
      "O overlap repete um trecho entre chunks vizinhos para que uma frase cortada ao meio continue recuperável.",
  },
  {
    ...
    answer: 1,
    explanation:
      "Filtrar por departamento/ano/tipo pode reduzir 1.000.000 de chunks para dezenas de milhares antes de comparar vetores.",
  },
  {
    ...
    answer: 1,
    explanation:
      "Busca vetorial é barata e ampla (recall). Reranking é cara e precisa (precision), então roda só no Top K.",
  },
  {
    ...
    answer: 1,
    explanation:
      "RAG responde. O agente persegue um objetivo em ciclos, agindo por meio de tools — e RAG pode ser uma delas.",
  },
];
